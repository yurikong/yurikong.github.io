 ...
 */
export const ProjectItem = forwardRef<ProjectItemRef, ProjectItemProps>(function ProjectItem(
  { imgName, details, className = '' },
  ref
): JSX.Element {
  ...
  return (
    <li className={fullClassName} ref={projectItemRef}>
      {/* 项目图片 */}
      <Image className={style['image']} name={imgName} alt='cover' watermark watermarkText='Jianqiang Du' />
