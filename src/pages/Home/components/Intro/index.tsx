...
import { StickyHeader, NavMenu, More } from '@/components'
 ...
 */
export const Intro = forwardRef<IntroRef, IntroProps>(function Intro({ onScrollToRef }, ref): JSX.Element {
  ...
  return (
    <section className={style['intro']} ref={introRef}>
      ...
      <div className={style['content']}>
        ...
        {/* 一句话形容自己 */}
        <h2 className={style['h2']}>I am a front-end developer who loves a good latte.</h2>
